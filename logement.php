...
function createLogement($nomlog, $adresslog, $cplog)
{
  global $dbh;
  ...
  $stmt1 = $dbh->prepare("INSERT INTO logement (log_id, usr_id, log_nom, log_adresse, log_cp, vil_id, typ_id)
   VALUES (NULL, :nomlog, :adresslog, :cplog) ");
  $stmt1->bindValue(':nomlog', $nomlog, PDO::PARAM_STR);
  $stmt1->bindValue(':adresslog', $adresslog, PDO::PARAM_STR);
  $stmt1->bindValue(':cplog', $cplog, PDO::PARAM_STR);
  if ( $stmt1->execute() ) {
